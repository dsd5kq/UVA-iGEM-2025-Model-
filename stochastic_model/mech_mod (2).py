...
steps = range(200000) #how long the simulation runs for
dt = 1 #the timesteps of the simulations

start_state='unbound'

times, A_MRNA_traj, B_MRNA_traj, A_traj, B_traj, C_traj, C_2_traj, TF_traj, states, transitions = stoc_mod_plus_plus(initial_conditionsA, initial_conditionsTF, start_state, steps, dt)
...
fig.tight_layout()
plt.savefig(f'output_figures/sim_{job_id}_graph.png')
plt.close()
