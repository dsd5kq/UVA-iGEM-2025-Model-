...
def ccda_odes(t, y, vk_BMRNA):
    ...
    k_AMRNA = 0.053515 #Guesstimation - CcdA mRNA formation rate real value 0.02751 0.053515
...
def ccdr_odes(t, x, cyst):
    ...
    O = cyst # guess - Based on cytotoxic concentration of cysteine taken one order of magnitude lower 7*10^-4
