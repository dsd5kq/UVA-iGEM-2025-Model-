...
# Example usage
#start_state = "unbound"
#num_steps = np.linspace(0,100,100)
#trajectory = simulate_markov_chain(start_state, num_steps)
#_, transitions=simulate_markov_chain('unbound', num_steps)
...
#plt.plot(times, A_MRNA_traj, label='CcdA mRNA')
#plt.plot(times, B_MRNA_traj, label='CcdB mRNA')

#Plot protein concentrations
#plt.plot(times, A_traj, label='CcdA protein')
#plt.plot(times, B_traj, label='CcdB protein')

#plt.xlabel('Time')
#plt.ylabel('Concentration')
#plt.title('CcdA/B mRNA and Protein Concentrations Over Time')
#plt.legend()
#plt.grid(True)
#plt.savefig(f'stoc_mod.png')
...
for test in range(1):
    ...
    #plt.legend()
    #plt.grid(True)
#plt.savefig(f'stoc_mod{test}.png')
